...
function AboutUs() {
  const team = [
    ...
    { image: amaraCole, name: "Amara Cole", role: "Chief Operations Officer" },
    {
      image: tobiDaniels,
      name: "Tobi Daniels",
      role: "Head of Solar Installations",
    },
    { image: ritaMadu, name: "Rita Madu", role: "Lead Energy Consultant" },
    {
      image: samuelAde,
      name: "Samuel Ade",
      role: "Sustainability and Research Manager",
    },
    {
      image: kelechiMoore,
      name: "Kelechi Moore",
  ...
  return (
    <div className="w-full px-6 mt-24 mb-20 md:px-10 lg:px-[2.4cm] py-10 font-['Roboto']">
      <div className="flex flex-col lg:flex-row items-start justify-between gap-10">
        <div className="w-full lg:max-w-[555px] flex flex-col justify-between">
          <div>
            <p className="text-[#48cc22] font-semibold  mt-4 text-[16px] mb-1">
              About Us
            </p>
            <div className="mb-4">
            ...
            <p className="text-[16px] leading-relaxed text-black">
              ...
              <span className="text-[#fc9d1e]">Org</span>, we provide innovative
              and reliable solar energy solutions tailored for organizations and
            ...
            <div className="space-y-6 mt-10">
              <div className="flex items-start gap-4">
                ...
                <p className="text-[16px]">
                  Hands-on training in solar system operation, maintenance, and
                  energy management
                </p>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <p className="text-[16px]">
                  Comprehensive insurance coverage for all solar panels
                  installed
                </p>
              </div>
            </div>
          ...
          <Link to="/projects">
            <button className="w-full sm:w-[270px] mt-8 text-[24px] font-bold text-white bg-[#fc9d1e] hover:bg-amber-600 py-4 rounded-lg transition duration-300">
      ...
      <div className="flex flex-col-reverse lg:flex-row items-start justify-between mt-20 gap-10">
        <div className="w-full lg:w-[13.5cm] h-auto">
          <img
            src={solarJourneyImage}
            alt="Our Solar Journey"
            className="w-full h-full object-cover rounded"
          />
        </div>

        <div className="w-full lg:w-[555px]">
          <p className="text-[40px] font-bold text-black mb-4">
            Our Solar Journey
          </p>
          <p className="text-[16px] leading-relaxed text-black">
            At <span className="text-[#48cc22]">Power</span>
            <span className="text-[#fc9d1e]">Org</span>, our journey began with
            a vision to make clean, renewable energy accessible to organizations
            and communities around the world. What started as a small initiative
            has grown into a trusted solar energy provider committed to reducing
            carbon footprints and driving sustainability through innovative
            solar solutions.
          </p>
        </div>
      </div>
      ...
      <div className="text-center mt-16">
        <div className="w-full max-w-[573px] mx-auto text-center">
          <p className="text-[36px] font-bold text-black">Meet Our Team</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 mt-10 place-items-center">
          {team.map((member, index) => (
            <div key={index} className="flex flex-col items-center text-center">
              ...
              <p className="mt-4 text-[24px] font-bold text-black hover:underline cursor-pointer">
                {member.name}
              </p>
              <p className="text-[15px] font-bold text-[#48cc22] hover:underline cursor-pointer">
                {member.role}
              </p>
            </div>
          ))}
