...
function Home() {
  ...
  return (
    <>
      <div
        className="h-[600px] mt-24 md:h-[800px] relative bg-cover bg-center"
        style={{ backgroundImage: `url(${HeaderImg})` }}
      >
        {/* Dark overlay */}
        <div className="absolute inset-0 bg-black bg-opacity-60 z-10" />

        {/* Text content - lifted above overlay */}
        <div className="absolute left-4 md:left-[108px] top-[100px] md:top-[185px] z-20 inline-flex flex-col justify-start items-start gap-7">
          <div className="flex flex-col justify-start items-start gap-4">
            ...
            <p className="w-full md:w-[561px] text-white text-base font-normal font-['Roboto'] leading-normal">
              We provide smart, affordable solar solutions to help you cut down
              electricity bills and enjoy 24/7 power. Whether it's your
              organization or business, we've got a solar system that fits your
              needs. Built for reliability and long-term savings.
            </p>
          </div>
          <Link to="/about-us">
            <button className="w-60 h-14 p-3 bg-amber-500 rounded-lg flex justify-center items-center">
              <span className="text-white text-2xl font-bold font-['Roboto'] leading-normal">
                Learn More
              </span>
            </button>
          </Link>
        ...
        <div className="flex flex-col md:flex-row justify-between items-start">
          ...
          <div className="w-full md:w-[837px] relative md:top-[145px] inline-flex flex-col gap-7 md:pl-16">
            ...
            <p className="text-neutral-700 text-lg md:text-xl font-normal font-['Roboto'] leading-loose tracking-tight">
              Our vision is to be a recognized leader in the renewable energy
              sector, driving the global transition to clean, sustainable power
              through innovative solar solutions. We aim to empower
              organizations, companies, and communities by providing accessible,
              efficient, and environmentally responsible energy systems that
              contribute to a greener future, reduce carbon footprints, and
      ...
      <div className="flex justify-center">
        <div className="w-full md:w-[746px] px-4 md:px-0 mt-12 gap-7 mb-16">
          <div className="text-center text-black pb-4 text-3xl md:text-5xl font-bold font-['Roboto'] leading-[48px]">
            All Energy Solutions
          </div>
          <div className="text-neutral-700 text-center text-lg md:text-2xl font-normal font-['Roboto'] leading-7 md:leading-10 tracking-wide">
            Variety of products to meet your needs is available.Visit us to
            learn more about our solar energy solutions{" "}
          </div>
        </div>
      </div>
      ...
      <div className="flex justify-center px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-xl">
          <div className="items-baseline-last pt-0 md:pt-32">
            <img
              className="w-full md:w-96 h-auto md:h-96"
              src={frame21}
              alt=""
            />
      ...
      <div className="flex justify-center px-4">
        <Link to="/projects">
          <button className="w-full md:w-72 h-14 p-3 bg-amber-500 mb-12 mt-4 mx-auto rounded-lg flex justify-center items-center gap-2 overflow-hidden">
            <div className="justify-center text-white text-2xl font-bold font-['Roboto'] leading-normal">
              All Services
            </div>
          </button>
        </Link>
        ...
        <div className="flex flex-col md:flex-row gap-12 items-center">
          ...
          <div className="w-full md:w-1/2">
            <div className="bg-black/25 rounded-lg overflow-hidden">
              <img
                src={solutionImg}
                alt="Solar energy engineer in orange safety vest standing in front of solar panels"
          ...
          <div className="w-full md:w-1/2 flex flex-col gap-6">
            <div className="flex items-center gap-2">
              ...
              <span className="text-lime-600 text-lg font-medium">
                SUSTAINABLE SOLUTIONS
              </span>
            </div>

            <h2 className="text-3xl md:text-4xl font-bold leading-tight text-black">
              Power Your Business with Smart, Flexible Energy Solutions
            </h2>

            <p className="text-neutral-700 text-base md:text-lg leading-relaxed">
              Our energy solutions are built for the future—designed to reduce
              costs, cut down carbon emissions, and improve daily operations for
              companies and organizations. From solar panels to wind systems, we
              provide hybrid setups tailored to your energy needs.
            </p>
            ...
            <div className="mt-6 space-y-6">
              <div className="flex items-center gap-4">
                ...
                <p className="text-neutral-700 text-base md:text-lg">
                  Solar and wind systems optimized for commercial use.
                </p>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <p className="text-neutral-700 text-base md:text-lg">
                  Hybrid solutions that improve energy efficiency and cost
                  savings.
                </p>
              </div>
            </div>
      ...
      >
        <div className="w-full md:w-[1000px] p-8 md:pl-44 inline-flex flex-col justify-start items-start gap-7">
          <p className="self-stretch pt-8 md:pt-20 justify-start text-white text-3xl md:text-5xl font-bold font-['Roboto'] leading-[48px]">
            Get A Solar Consultation
          </p>
          <p className="self-stretch justify-start text-white text-base md:text-xl font-normal font-['Roboto'] leading-loose">
            Get expert guidance on the best solar energy solutions for your
            organization. Our team evaluates your energy needs, budget, and site
            conditions to design a customized solar plan that maximizes
            efficiency and savings. From system recommendations to installation
            timelines, we'll walk you through every step — no guesswork, just
            clarity.
          </p>
          <div className="w-full md:w-72 h-16 p-3 bg-orange-400 rounded-lg inline-flex justify-center items-center gap-2 overflow-hidden">
            <Link to="/contact">
              <button className="text-center justify-start text-white text-xl md:text-2xl font-bold font-['Roboto'] leading-normal">
                Book a Consultation
              </button>
            </Link>
          </div>
      ...
      <section className="flex flex-col md:flex-row justify-around py-12 md:py-20 px-4 md:px-0 bg-[#EFF6ED] items-center gap-10 mt-12 md:mt-20">
        <div className="w-full md:w-[525px]">
          <h2 className="text-3xl md:text-[48px] font-semibold leading-none pb-2">
            What our partners say about us
          </h2>
          <p className="text-base md:text-lg">
            At{" "}
            <span className="text-[#41CA1A] text-lg md:text-[20px]">Power</span>
            <span className="text-[#FF9E1B]">Org</span>, we're committed to
            helping businesses switch to smarter, sustainable energy solutions.
            Our clients appreciate the cost savings, smooth installation
            process, and ongoing support we provide.Their feedback drives us to
            deliver even better service every day.
          </p>
        </div>
        <div className="inline-flex flex-col justify-start items-start w-full md:w-auto">
          ...
          <div className="w-full md:w-[589px] self-stretch h-auto md:h-96 relative bg-white overflow-hidden p-4 md:p-0">
            <div className="px-2 inline-flex flex-col md:pl-10 pt-8 md:pt-24 italic text-lg md:text-[20px] justify-start items-start gap-2">
              <p className="self-stretch justify-start text-neutral-700 text-base md:text-xl font-normal font-['Poppins'] leading-loose">
                Switching to solar with this company was one of the best
                decisions we've made for our operations. The system was
                installed seamlessly, and we're already seeing major savings.
                Highly recommended!
              </p>
              <p className="self-stretch justify-start text-black text-lg md:text-xl font-bold font-['Inter'] leading-loose">
                Richard Abiola
              </p>
              <p className="self-stretch justify-start text-orange-400 text-lg md:text-xl font-bold font-['Poppins'] leading-loose">
                Facility Manager
              </p>
            </div>
          </div>
