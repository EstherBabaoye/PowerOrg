...
export default function Header() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white w-full px-4 md:px-24 py-5 flex flex-wrap justify-between items-center">
      <div className="flex justify-start items-center">
        <span className="text-[#48cc22] text-4xl font-bold font-['Roboto'] leading-9">
          Power
        </span>
        <span className="text-[#fc9d1e] text-4xl font-bold font-['Roboto'] leading-9">
          Org
        </span>
      </div>
